...
export function HeroPhoto() {
  return (
    <>
           {/* Mobile: smaller, centered, in-flow above the headline */}
      <div className="relative mx-auto mb-6 h-32 w-32 md:hidden">
        <div className="absolute -inset-1 rounded-full border border-primary/30 shadow-[0_0_20px_2px_rgba(0,229,255,0.15)]" />
      ...
      {/* Desktop: floating, absolute-positioned, corner brackets */}
